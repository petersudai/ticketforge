    ...
    <footer className="border-t border-white/[0.06] bg-[#06060e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-10 mb-10 sm:mb-12">
          ...
          {/* Product */}
          <div>
            <div className="text-[11px] font-semibold text-white/50 uppercase tracking-widest mb-4 font-heading">Product</div>
          ...
          {/* Organizers */}
          <div>
            <div className="text-[11px] font-semibold text-white/50 uppercase tracking-widest mb-4 font-heading">Organizers</div>
            <div className="flex flex-col gap-2.5">
          ...
          {/* Company */}
          <div>
            <div className="text-[11px] font-semibold text-white/50 uppercase tracking-widest mb-4 font-heading">Company</div>
            <div className="flex flex-col gap-2.5">
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-[12px] text-white/50">© {new Date().getFullYear()} TicketForge Pro. All rights reserved.</span>
          <div className="flex items-center gap-6">
            {["Twitter", "LinkedIn", "GitHub"].map(s => (
              <Link key={s} href="#" className="text-[12px] text-white/50 hover:text-white/60 transition-colors">{s}</Link>
            ))}
          </div>
        </div>
      </div>
